    ...
    <div className='container bg-black py-16'>
        ...
        <div className='grid grid-cols-3 gap-5 mt-16'>
            <div className='glassCard flex items-center justify-between rounded-3xl px-16'>
                ...
                <div>
                    <h1 className='font-Neue-Montreal-Bold text-5xl text-white'>312k</h1>
            ...
            <div className='flex items-center flex-col gap-4'>
                <div className='glassCard w-full flex items-center justify-between rounded-3xl px-8 py-6'>
                    <div className='glassCard flex items-center p-5 justify-center rounded-full'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-[40px] text-white">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" />
                            <path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                        </svg>
                    </div>
                    <div>
                        <h1 className='font-Neue-Montreal-Bold text-white text-5xl'>472k</h1>
                ...
                <div className='glassCard flex items-center justify-between rounded-3xl px-8 py-4'>
                    <div>
                        <p className='text-secondery font-Neue-Montreal-Regular'>Sketchfab, Vectary, and Spline let you upload and view 3D models in the browser — great for show casing or creative use.</p>
                    </div>
                </div>
            </div>
